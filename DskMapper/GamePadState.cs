...
namespace DskMapper
{
    ...
    {
        protected Boolean m_CuD;
        protected Int32 m_CuD_Repeat;
        protected Boolean m_CuL;
        protected Int32 m_CuL_Repeat;
        protected Boolean m_CuR;
        protected Int32 m_CuR_Repeat;
        protected Boolean m_CuU;
        // Repeat Counters
        protected Int32 m_CuU_Repeat;
        protected Boolean m_Enabled = true;
        // Control
        protected Boolean m_Enb;
        // Keyboard
        protected Boolean m_Ent;
        protected Boolean m_Esc;
        // Mouse
        protected Boolean m_LMB;
        protected Boolean m_PgD;
        protected Boolean m_PgU;
        protected Boolean m_RMB;
        protected Boolean m_Spc;
        protected Boolean m_Tab;
